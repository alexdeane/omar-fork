...
<!--        <table border="0" cellspacing="0" cellpadding="0">-->
            <form name="{$form-id}" action="{$action-url}" method="post" enctype="application/x-www-form-urlencoded" target="result">
...
<!--
$Log: query.xsl,v $
Revision 1.1  2003/12/04 18:01:39  psterk
Initial version.  This file is used by the SQLQuery.xhtml XForm.
