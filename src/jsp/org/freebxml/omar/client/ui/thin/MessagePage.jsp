...
<body bgcolor='#ffffff' onload="lastCall()">
    <h:panelGrid id="messagePagePanel" bgcolor="#ffffff" columns="2" cellspacing="0" cellpadding="0" 
        columnClasses="leftPanelColumn, rightPanelColumn">
        <h:panelGrid id="messageDiscPanel" bgcolor="#ffffff" width="100%" 
           cellspacing="0" cellpadding="0" rowClasses="MstDiv">
            <c:import url="/Logo.jsp"/>
            <c:import url="/DiscoveryPanel.jsp"/>
        </h:panelGrid>
        <h:panelGrid id="messageToolPanel" bgcolor="#ffffff" width="100%" 
