...
<body bgcolor='#ffffff'>
        <h:panelGrid id="registrationPagePanel" bgcolor="#ffffff" columns="2"  
            cellspacing="0" cellpadding="0" columnClasses="leftPanelColumn, rightPanelColumn">
            <h:panelGrid id="registrationDiscPanel" bgcolor="#ffffff" width="100%" 
               cellspacing="0" cellpadding="0" rowClasses="MstDiv">
               <c:import url="/Logo.jsp"/>      
               <c:import url="/DiscoveryPanel.jsp"/>
            </h:panelGrid>
            <h:panelGrid id="registrationToolPanel" bgcolor="#ffffff" width="100%" 
               cellspacing="0" cellpadding="0">
               <c:import url="/Banner.jsp"/>
               <c:import url="/Toolbar.jsp"/>
               <c:import url="/RegistrationWizard.jsp"/>
        </h:panelGrid>
   </h:panelGrid>
