...
<body bgcolor='#ffffff'>
    <h:panelGrid id="exportPanel" bgcolor="#ffffff" cellspacing="0" cellpadding="0" 
        columns="2" columnClasses="leftPanelColumn, rightPanelColumn">
        <h:panelGrid id="exportDiscPanel" bgcolor="#ffffff" width="100%" 
            cellspacing="0" cellpadding="0" rowClasses="MstDiv">
            <c:import url="/Logo.jsp"/>
            <c:import url="/DiscoveryPanel.jsp"/>
        </h:panelGrid>
        <h:panelGrid id="exportToolPanel" bgcolor="#ffffff" width="100%" 
            cellspacing="0" cellpadding="0" >
            <c:import url="/Banner.jsp"/>
            <c:import url="/Toolbar.jsp"/>
            <c:import url="/ExportObjects.jsp"/>
        </h:panelGrid>
    </h:panelGrid>
