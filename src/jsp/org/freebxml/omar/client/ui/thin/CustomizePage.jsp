...
<body bgcolor='#ffffff'>
    <h:panelGrid id="customizePanel" bgcolor="#ffffff" cellspacing="0" cellpadding="0" 
        columns="2" columnClasses="leftPanelColumn, rightPanelColumn">
        <h:panelGrid id="customizeDiscPanel" bgcolor="#ffffff" width="100%" 
            cellspacing="0" cellpadding="0" rowClasses="MstDiv">          
            <c:import url="/Logo.jsp"/>
            <c:import url="/DiscoveryPanel.jsp"/>
       </h:panelGrid>
       <h:panelGrid id="customizeToolPanel" bgcolor="#ffffff" width="100%" 
            cellspacing="0" cellpadding="0">
            <c:import url="/Banner.jsp"/>
            <c:import url="/Toolbar.jsp"/>
            <c:import url="/CustomizeMessage.jsp"/>
       </h:panelGrid>
    </h:panelGrid>
