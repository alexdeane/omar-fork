...
public class ContentCatalogingServiceSOAPService_SerializerRegistry implements SerializerConstants {
    public ContentCatalogingServiceSOAPService_SerializerRegistry() {
    }
    ...
    public TypeMappingRegistry getRegistry() {
        ...
        {
            QName type = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:cms:3.0", "CatalogContentRequest");
        ...
        {
            QName type = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:cms:3.0", "CatalogContentResponse");
            CombinedSerializer serializer = new LiteralFragmentSerializer(type, NOT_NULLABLE, "");
            registerSerializer(mapping2,javax.xml.soap.SOAPElement.class, type, serializer);
        }
        return registry;
