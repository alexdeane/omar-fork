 ...
 *
 * $Header: /cvsroot/ebxmlrr/omar/src/java/org/freebxml/omar/common/security/xwssec10/ExtendedImportCertificateTokenFilter.java,v 1.3 2005/06/11 00:20:53 geomurr Exp $
 * ====================================================================
 */
    ...
    implements MessageFilter
{
	...
	try {
	    ...
	    FilterBase.log.log(Level.SEVERE,
			       CommonResourceBundle.getInstance().getString("message.WSS0156.exception.in.cert.validate",
