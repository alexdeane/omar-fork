 ...
 *
 * $Header: /cvsroot/ebxmlrr/omar/src/java/org/freebxml/omar/server/lcm/LifeCycleManagerImpl.java,v 1.77 2007/06/06 15:26:38 yamanu Exp $
 * ====================================================================
 */
...
import org.oasis.ebxml.registry.bindings.rim.impl.RegistryObjectImpl;
...
public class LifeCycleManagerImpl implements LifeCycleManager {
     ...
     */
    private void insertPackageMembers(RegistryObjectListType regObjs, RegistryPackage regPkg) throws JAXBException {
        if (regPkg.getRegistryObjectList() != null && regPkg.getRegistryObjectList().getIdentifiable().size() > 0) {
            ...
            for (int j = 0; j < regPkg.getRegistryObjectList().getIdentifiable().size(); j++) {
                RegistryObjectType ro = (RegistryObjectType)regPkg.getRegistryObjectList().getIdentifiable().get(j);
                        
                if (ro instanceof RegistryPackage) {
                    insertPackageMembers(regObjs, (RegistryPackage)ro);
                }
    ...
    */
	...
	throws UnauthorizedRequestException, RegistryException {
        ...
        boolean noRegRequired = Boolean.valueOf(CommonProperties.getInstance()
