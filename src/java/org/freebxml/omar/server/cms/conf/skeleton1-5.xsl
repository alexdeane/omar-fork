...
<!-- Beta Skeleton Module for the Schematron 1.5 XML Schema Language.
 ...
 THIS VERSION MODIFIED BY SUN MICROSYSTEMS, INC 2005/11/04
  - The following namespaces have been added to top level element <xsl:stylesheet> to
    correct namespace resolution issues.
    xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/"
    xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/
  - A new line character has been added to <xsl:template match="text()" />  
    This enables easier parsing of target document to determine success or failure.
