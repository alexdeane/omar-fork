 ...
 *
 * $Header: /cvsroot/ebxmlrr/omar/src/java/org/freebxml/omar/server/query/QueryManagerImpl.java,v 1.76 2007/05/25 23:26:38 psterk Exp $
 * ====================================================================
 */
            ...
            if (((ServerRequestContext)context).getSpecialQueryResults() != null) {
                ...
                if (isFederated) {
                    ...
                    if (queryLang.equals(BindingUtility.CANONICAL_QUERY_LANGUAGE_ID_SQL_92)) {
                        ...
                        FilterQueryType filterQuery = (FilterQueryType)unmarshaller.unmarshal(
                                new StreamSource( new StringReader(queryStr)));
