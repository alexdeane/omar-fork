 ...
 *
 * $Header: /cvsroot/ebxmlrr/omar/src/java/org/freebxml/omar/server/query/filter/AdhocQueryQueryProcessor.java,v 1.3 2005/03/29 09:22:56 farrukh_najmi Exp $
 * ====================================================================
 */
 ...
 *
 */
class AdhocQueryQueryProcessor extends RegistryObjectQueryProcessor {
    
    public AdhocQueryQueryProcessor(FilterQueryProcessor parentQueryProcessor, FilterQueryType filterQuery) throws RegistryException {
