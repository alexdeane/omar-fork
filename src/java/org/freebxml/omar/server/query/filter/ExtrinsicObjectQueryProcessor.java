 ...
 *
 * $Header: /cvsroot/ebxmlrr/omar/src/java/org/freebxml/omar/server/query/filter/ExtrinsicObjectQueryProcessor.java,v 1.9 2005/03/29 09:22:56 farrukh_najmi Exp $
 * ====================================================================
 */
 ...
 *
 */
class ExtrinsicObjectQueryProcessor extends RegistryObjectQueryProcessor {
    
    public ExtrinsicObjectQueryProcessor(FilterQueryProcessor parentQueryProcessor, FilterQueryType filterQuery) throws RegistryException {
