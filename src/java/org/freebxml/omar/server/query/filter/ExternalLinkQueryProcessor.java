 ...
 *
 * $Header: /cvsroot/ebxmlrr/omar/src/java/org/freebxml/omar/server/query/filter/ExternalLinkQueryProcessor.java,v 1.3 2005/03/29 09:22:56 farrukh_najmi Exp $
 * ====================================================================
 */
 ...
 *
 */
class ExternalLinkQueryProcessor extends RegistryObjectQueryProcessor {
    
    public ExternalLinkQueryProcessor(FilterQueryProcessor parentQueryProcessor, FilterQueryType filterQuery) throws RegistryException {
