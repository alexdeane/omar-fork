 ...
 *
 * $Header: /cvsroot/ebxmlrr/omar/src/java/org/freebxml/omar/client/common/RegistryMappedModel.java,v 1.1 2006/04/10 10:59:07 tonygraham Exp $
 * ====================================================================
 */
...
public abstract class RegistryMappedModel extends Observable
     ...
     *
     * @see org.freebxml.omar.client.common.model.MappedModel#setKey(String)
     *
     ...
     *
     * @see org.freebxml.omar.client.common.model.Model#validate()
     */
